...
process.stdin.once('data', function (data){
	...
	process.stdin.once('data', function (data){
		...
		console.log('\t $ heroku config:set LOG_USERNAME='+sanitizeOutput(credentials.username));
		console.log('\t $ heroku config:set LOG_PASSWORD='+sanitizeOutput(credentials.password));
